const geneticsRegulationBio = {
   index: 13,
   itemName: "Gene Regulation",
   folderName: "Gene Regulation",
   type: "Molecular",
   entries: [
      {
      ...
      },
      {
         ...
         "data": [
            {
               "name": "mRNA",
               "value": "synthe­­sized using DNA template, attaches to ribosome in cytoplasm and specifies the primary structure of protein"
            },
            {
               "name": "rRNA",
               "value": "molecu­­le­s...and proteins make up the ribos­omes"
            },
            {
               "name": "tRNA",
               "value": "translates between nucleic acid (DNA) and protein lang. by carrying specific amino acids to ribosome, where they recognize the approp­­riate codons in the mRNA"
            }
         ]
      },
      {
      ...
      },
      {
         ...
         "data": [
            ...
            },
            {
               "columns": [
                  {
                     "value": "one chromosome"
                  },
                  {
                     "value": "usually more than one chromosome"
                  }
               ]
            },
            {
            ...
            },
            {
               "columns": [
                  ...
                  {
                     "value": "DNA wrapped around histones (proteins)"
                  }
               ]
            },
            {
               "columns": [
                  {
                     "value": "superc­oiled DNA"
                  },
                  {
                     "value": "forms chromatin"
                  }
               ]
            }
         ]
         ...
         "data": [
            {
               "columns": [
                  {
                     "value": "Double Stranded, Anti-p­arallel"
                  },
                  {
                     "value": "Single Stranded"
                  }
            ...
            },
            {
               "columns": [
                  {
                     "value": "Mostly Found in Nucleus"
                  },
                  {
                     "value": "Mostly Found in Cytoplasm"
                  }
               ]
            },
            {
            ...
            },
            {
               "columns": [
                  {
                     "value": "Forms Double Helix Structure"
                  },
                  {
                     "value": "Forms Secondary or Tertiary Structure"
                  }
               ]
            }
         ]
         ...
         "data": [
            ...
            },
            {
               "columns": [
                  ...
                  {
                     "value": "sequences that will be translated"
                  }
               ]
            },
            {
               "columns": [
                  {
                     "value": "Small ribonu­cle­opr­otein particles (snRNPs \"­snu­rps­\")"
                  },
                  {
                     "value": "Looks for introns and exons and recognizes it."
                  }
               ]
            },
            {
               "columns": [
                  {
                     "value": "Spli­ceo­somes"
                  },
                  {
                     "value": "respon­sible for removing introns"
                  }
               ]
            },
            {
               "columns": [
                  {
                     "value": "snRNPs cluster with other proteins to form spli­ceo­some"
                  }
               ]
            }
         ]
      ...
      },
      {
         ...
         "data": [
            {
               "name": "DNA",
               "value": "Nucleic acid that transmits genetic inform­ation from parent to offspring and codes for the production of proteins"
            },
            {
               "name": "Nucleotide",
               "value": "Building block of nucleic acids"
            },
            {
               "name": "Double Helix",
               "value": "Structure of two strands, intert­wining around an axis like a twisted ladder"
            },
            {
               "name": "DNA replic­ation",
               "value": "Process during which a double­-st­randed DNA molecule is copied to produce two identical DNA molecules"
            },
            {
               "name": "Base",
               "value": "Principle in which the nitrog­enous bases of the DNA molecules bond with one another (AT, CG))"
            }
         ]
      },
      {
         ...
         "data": [
            {
               "columns": [
                  {
                     "value": "takes place in cytoplasm"
                  },
                  {
                     "value": "takes place in nucleus"
                  }
               ]
            },
            {
               "columns": [
                  {
                     "value": "several gene transc­ribed at one time"
                  },
                  {
                     "value": "single gene transc­ribed at one time"
                  }
               ]
            },
            {
               "columns": [
                  {
                     "value": "no modifi­cations before transl­ation"
                  },
                  {
                     "value": "primary transcript modified before transl­ation"
                  }
               ]
            }
         ]
      },
      {
         ...
         "data": [
            ...
            },
            {
               "columns": [
                  {
                     "value": "ribosomes begin transl­ating while mRNA is still transc­ribing"
                  },
                  {
                     "value": "transc­ription and transl­ation separate"
                  }
               ]
            }
         ]
      ...
      },
      {
         ...
         "data": [
            {
               "name": "The Lac Operon of E.Coli",
               "value": "* Condit­ions: Lactose is available and Glucose is not."
            }
         ]
      },
      {
      ...
      {
         "title": "Transc­ription & Transl­ation",
         "type": "NORMAL",
         "image": "TRANSCRIPTION_and_TRANSLATION",
         "data": []
      },
      {
         ...
         "data": [
            {
               ...
               "value": "Inform­ation only flows from: DNA→­RNA­→­protein\nFirst described by Francis Crick."
            },
            {
               "name": "Tran­scr­ipt­ion",
      ...
      {
         "title": "Water/­Lip­id-­Soluble Hormone Signaling",
         "type": "NORMAL",
         "image": "WATER_LIPID_SOLUBLE_HORMONE_SIGNALING",
         "data": []
      },
      {
         ...
         "data": [
            {
               ...
               "value": "alter a single base"
            },
            {
               "name": "Base substi­tut­ion",
               "value": "substitute one base for another"
            },
            {
               "name": "Siletn mutation",
               "value": "same amino acid inserted"
            },
            {
               "name": "Missense mutation",
               "value": "changes amino acid inserted\n- Transi­tions\n- Transv­ersions"
            },
            {
               "name": "Nonsense mutati­ons",
               "value": "changed to stop codon\n"
            }
         ]
      },
      {
         ...
         "data": [
            {
               "columns": [
                  ...
                  {
                     "value": "affects 1 nucleotide pair"
                  }
               ]
            },
            {
               "columns": [
                  {
                     "value": "1. silent mutations"
                  },
                  {
                     "value": "do not change amino acid transl­ation"
                  }
               ]
            },
            {
               "columns": [
                  {
                     "value": "2.missense mutations"
                  },
                  {
                     "value": "a single nucleotide change results in a codon that codes for a different amino acid"
                  }
               ]
            },
            {
               "columns": [
                  {
                     "value": "3. nonsense mutation"
                  },
                  {
                     "value": "a regular amino acid codon is changed into a stop codon, ending transl­­ation"
                  }
               ]
            },
            {
               "columns": [
                  {
                     "value": "inse­rtion or deletion",
                     "styles": [
                        "BOLD"
                     ]
                  },
                  {
                     "value": "additi­on/loss of nucleotide pairs"
                  }
               ]
            },
            {
               "columns": [
                  {
                     "value": "1. frame shift mutation"
                  },
                  {
                     "value": "deletion or insertion in a DNA sequence that shifts the way the sequence is read"
                  }
               ]
            },
            {
               "columns": [
                  ...
                  {
                     "value": "forces that interact with DNA in ways that cause mutation example: xrays"
                  }
               ]
            }
         ]
...
export default geneticsRegulationBio;