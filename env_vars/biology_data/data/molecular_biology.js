const molecularBio = {
   ...
   folderName: "Cellular - Molecular Biology",
   type: "Neurobiology",
   entries: [
      {
      ...
      },
      {
         ...
         "data": [
            {
               "name": "Biomolecule",
               "value": "A biomol­ecule is any molecule that is produced by a living organism, including large macrom­ole­cules such as proteins, polysa­cch­arides, lipids, and nucleic acids, as well as small molecules such as primary metabo­lites, secondary metabo­lites, and natural products."
            },
            {
               "name": "Types of biomol­ecules",
               "value": "A Small molecules: Lipids, polysa­cch­arides, glycol­ipids, sterols, glycer­olipids Vitamins Hormones, neurot­ran­smi­tters Metabo­lites"
            },
            {
               "name": "Saccharides",
               "value": "Monosa­cch­arides are the simplest form of carboh­ydrates with only one simple sugar. They essent­ially contain an aldehyde or ketone group in their structure."
            },
            {
               "name": "Disaccharides",
            ...
            {
               "name": "Lignin",
               "value": "Lignin is a complex polyph­enolic macrom­olecule composed mainly of beta-O­4-aryl linkages."
            },
            {
               "name": "Lipids",
               "value": "Lipids (oleag­inous) are chiefly fatty acid esters, and are the basic building blocks of biological membranes."
            },
            {
               "name": "Amino Acids",
               "value": "Amino acids contain both amino and carboxylic acid functional groups. (In bioche­mistry, the term amino acid is used when referring to those amino acids in which the amino and carbox­ylate functi­ona­lities are attached to the same carbon, plus proline which is not actually an amino acid)."
            },
            {
               "name": "Protein structure",
               "value": "The particular series of amino acids that form a protein is known as that protein's primary structure. This sequence is determined by the genetic makeup of the indivi­dual. It specifies the order of side-chain groups along the linear polype­ptide \"­bac­kbo­ne\"."
            }
         ]
      },
      {
         ...
         "data": [
            ...
            },
            {
               ...
               "value": "Convert sunlight to chemical energy. Use this chemical energy to do work. Generate heat and disorder on the process (increases entropy)"
            },
            {
               "name": "Entropy",
               "value": "may decrease in living things (living things show order), but the total entropy of the universe increases in the process"
            },
            {
               "name": "Life",
               "value": "uses energy to create order but thus energy also creates disorder."
            }
         ]
      },
      {
      ...
      },
      {
         ...
         "data": [
            {
               "name": "Biogenetics:",
               "value": "Principles of thermo­dyn­amics applied to reactions and process of cells. Allows insight into how cells handle energy transa­ctions."
            },
            {
               "name": "System + Surrou­ndings:",
               "value": "Closed: no energy exchange Open: energy can be added or removed Every change produces either heat or work"
            },
            {
               "name": "For Thermo­dynamic Measur­ements:",
               "value": "Standard conditions pH=7, T=25 degrees C, 1 Atm, Pressure State usually constant under biological conditions"
            },
            {
               "name": "First law of thermo­dyn­amics:",
               "value": "Energy cannot be created or destroyed, but it can be changed from one form to another."
            },
            {
               "name": "Second law of thermo­dyn­amics:",
               "value": "Whenever changes form, entropy increases. Whenever energy changes form, some energy is lost ( unusable by the organism. Energy is conserved as a whole, but not in any system doing work."
            },
            {
               "name": "Metabolism:",
               "value": "the sum of all chemical reactions in an organism a bala­nce between reactions which release energy and those that require energy"
            },
            {
               "name": "Catabolism:",
            ...
            {
               "name": "Enzymes:",
               "value": "Guide metabolic pathways"
            },
            {
               "name": "Gibb's Free Energy:",
               "value": "Energy released that is available to do useful work"
            },
            {
               "name": "Spon­tan­eous:",
      ...
      },
      {
         ...
         "data": [
            ...
            {
               "name": "Non-spontaneous Reaction",
               "value": "Store energy(endergonic)"
            },
            {
               "name": "∆G=",
               "value": "∆H-T∆S"
         ...
         "data": [
            {
               "columns": [
                  {
                     "value": "Form of cellular respir­ation in eukaryotes and many prokar­yotes"
                  },
                  {
                     "value": "Form of cellular respir­ation in some prokar­yotes"
                  }
               ]
            },
            {
               "columns": [
                  {
                     "value": "Oxygen is needed in the ATP producing process"
                  },
                  {
                     "value": "A molecule other than oxygen, such as sulfate of nitrate, is used in the ATP producing process"
                  }
               ]
            }
         ]
