final dynamic plantBio = {
  "index": 5,
  "itemName": "Plant Biology",
  "imageFolder": "PLANT_BIOLOGY",
  "folderName": "Plant Biology",
  ...
  "entries": [
    {
      ...
      "data": [
        {
          "name": "How are plant cells different from animal cells?",
          "value":
              "These following structures are in plant cells: chloro­plasts, a large vacuole, plant cell walls"
        },
        {
          "name": "How do we think mitoch­ondria and chloro­plasts evolved?",
          "value": "from aerobic, oxygen­-co­nsu­ming, prokar­yotes"
        },
        {
          "name":
    ...
    },
    {
      ...
      "data": [
        ...
        },
        {
          ...
          "values": [
            {"type": "NORMAL", "value": "contains "},
            {
              "type": "NORMAL",
              "value": "cell sap",
              "styles": ["ITALIC"]
            },
            {"type": "NORMAL", "value": ", a weak solution of sugar and salts"}
          ]
        },
        {
          "name": "Chloroplasts",
          "values": [
            {"type": "NORMAL", "value": "these are where "},
            {
              "type": "NORMAL",
            ...
            },
            {
              "type": "NORMAL",
              "value":
                  "occures, which makes food for the plant; they contain a green substance called "
            },
            {
              "type": "NORMAL",
              "value": "chlorophyll",
      ...
      "data": [
        {
          "name": "Plasticidia:",
          "value":
              "Organejos that serve as factory and important reserve of chemical compounds. They are classified into leukoplasts, chromoplasts and chloroplasts."
        },
        {
          "name": "Leukoplastic:",
        ...
        },
        {
          "name": "Chromoplasts:",
          "value":
              "They give color to the fruit or flower. For example, lycopene (tomato), beta-carotene (carrot)"
        },
        {
          "name": "Great central vacuole:",
          "value": "Water tank and various chemical substances."
        },
        {"name": "Chloroplasts:", "value": "They carry out photosynthesis."}
      ]
    },
    {
    ...
    {"title": "Plastids", "type": "NORMAL", "image": "PLASTIDS", "data": []},
    {
    ...
    },
    {
      ...
      "type": "NORMAL",
      "data": [
        {"name": null, "value": "6CO2 + 6H2O → C6H12O6 + 6O2"}
      ]
    },
    {
    ...
    },
    {
      ...
      "data": [
        {
          "columns": [
            {"value": "in chloro­plasts"},
            {"value": "in mitoch­ondria"}
          ]
        },
        {
          "columns": [
            {"value": "reactants- CO2, water, NRG"},
            {"value": "reactants- sugar, oxygen, NRG"}
          ]
        },
        {
          "columns": [
            {"value": "ETC-th­ylakoid membrane"},
            {"value": "ETC- inner membrane"}
          ]
        },
        {
          "columns": [
            {"value": "chem rxn cycles­-calvin cycle"},
            {"value": "krebs cycle"}
          ]
        },
        {
          "columns": [
            {"value": "products- sugar, oxygen"},
            {"value": "CO2, water, ATP"}
          ]
        },
        {
          "columns": [
            {"value": "ETC- electron transport chain"}
          ]
        }
      ]
    },
    {
      ...
      "data": [
        ...
        {
          "columns": [
            {"value": "grana-­stage 1- light dependent reactions"},
            {
              "value":
        ...
        {
          "columns": [
            {"value": "photos­ystem 2- capture and transfer NRG"},
            {
              "value":
    ...
    },
    {
      ...
      "data": [
        ...
        {
          "name": "Brassi­nos­teroids",
          "value":
              "Induces cell elongation & division in stem segments, slow leaf abscission."
        },
        {
    ...
    },
    {
      ...
      "type": "NORMAL",
      "image": "EXPERIMENT_MEASURE_RATE_P_S",
      "data": [
        {"name": null, "value": null}
      ]
    },
    {
      ...
      "data": [
        ...
        {
          "columns": [
            {"value": "1. glycolysis splits glucose into 2 pyruvate molecules"},
            {
              "value":
        ...
        {
          "columns": [
            {"value": "2. 2 pyruvates and 2 NADH enter fermen­tation"},
            {"value": "3. NADH is recycled back into NAD+"}
          ]
        },
        {
          "columns": [
            {"value": "3. NRG from NADH converts pyruvate into lactic acid"},
            {"value": "4. NAD+ is recycled to glycolysis"}
          ]
        },
        {
          "columns": [
            {"value": "NADH changed back to NAD+"},
            {"value": "used in food production and by bacteria"}
          ]
        },
        {
          "columns": [
            {"value": "-Does not produce ATP\n-Anaerobic"}
          ]
        }
      ]
    },
